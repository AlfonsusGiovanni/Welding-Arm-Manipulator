...
/* Definitions for runningTask */
osThreadId_t runningTaskHandle;
const osThreadAttr_t runningTask_attributes = {
  .name = "runningTask",
  .stack_size = 128 * 4,
...
void StartRunning(void *argument);
...
int main(void)
{
  ...
  receiveTaskHandle = osThreadNew(StartReceive, NULL, &receiveTask_attributes);

  /* creation of transmitTask */
  transmitTaskHandle = osThreadNew(StartTransmit, NULL, &transmitTask_attributes);

  /* creation of comTask */
  comTaskHandle = osThreadNew(StartCommandTask, NULL, &comTask_attributes);

  /* creation of moveTask */
  moveTaskHandle = osThreadNew(StartMoveTask, NULL, &moveTask_attributes);

  /* creation of runningTask */
  runningTaskHandle = osThreadNew(StartRunning, NULL, &runningTask_attributes);

  /* creation of mappingTask */
...
/* USER CODE BEGIN Header_StartRunning */
/**
* @brief Function implementing the runningTask thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_StartRunning */
void StartRunning(void *argument)
{
  /* USER CODE BEGIN StartRunning */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
  }
  /* USER CODE END StartRunning */
}

/* USER CODE BEGIN Header_StartMappingTask */
/**
* @brief Function implementing the mappingTask thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_StartMappingTask */
void StartMappingTask(void *argument)
{
  /* USER CODE BEGIN StartMappingTask */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
  }
  /* USER CODE END StartMappingTask */
}
